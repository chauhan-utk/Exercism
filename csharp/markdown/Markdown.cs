...
public static class Markdown
{
    ...
    private static string ParseHeader(string markdown, bool inListBefore, out bool inListAfter)
    {
        var count = 0;
    ...
    private static string ParseLineItem(string markdown, bool inListBefore, out bool inListAfter)
    {
